    ...
    return (
        ...
        >
            ...
            <div className='flex items-center gap-1'>
                { project?.url ? (
                    <div onClick={() => handleWebClick(project)} className='font-medium cursor-pointer text-white/50'>
                        <ArrowTopRightOnSquareIcon className='w-6 h-6 text-white'/>
                    </div>      
                ) : null }
                { project?.repo ? (
                    <div onClick={() => handleSourceClick(project)} className='font-medium cursor-pointer text-white/50'>
