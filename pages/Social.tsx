...
function Social({ social }: Props) {
    ...
    return (
        ...
        }} className="flex items-center w-full p-3 space-x-5 tracking-wider transition-all duration-300 rounded-lg shadow-lg cursor-pointer justify-evenly bg-black/20 backdrop-blur-xl hover:bg-black/30 backdrop-blur-4xl xl:p-3" key={social?._id}>
