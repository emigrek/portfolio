...
function Skills() {
  ...
  return (
    <div className="max-w-5xl w-full mt-24 md:mt-28 z-[1] flex flex-col gap-2 md:gap-8">
      <div className='flex flex-col items-center w-full gap-3 px-4 md:gap-0 md:flex-row md:justify-between'>
        ...
        <div className='relative w-full'>
          ...
          <div className='flex items-center w-full gap-1 px-1 py-2 overflow-x-auto md:px-0 md:justify-end scrollbar-thin scrollbar-thumb-white/60 scrollbar-track-transparent'>
