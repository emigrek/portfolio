  ...
  return (
    <div className="z-[2] flex flex-col items-center justify-center gap-8 md:flex-row">
      <div className="flex flex-row items-center gap-8 mx-auto md:gap-0 lg:items-start md:flex-col">
        <Image
          priority
          className="relative mx-auto rounded-full shadow-xl w-36 lg:w-44"
          src={avatarSrc}
          width={500}
          height={500}
          alt="Face"
      ...
      <Sheet className="flex flex-col max-w-md gap-3 mx-4 text-center md:mx-0">
        <div className="text-justify text-neutral-200 ">
          <span className={`p-2 md:text-xl`}>👋</span>
        ...
        <div className="text-lg font-medium text-center">
          ...
          <Link
            href="#projects"
            className="underline decoration-blue-500/30 hover:decoration-blue-500 underline-offset-4"
          >
            my projects
          </Link>
          , reach me anytime! <span className="hidden md:inline-block">👉</span>
